...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post sensors_url, params: { sensor: { sensor_name: @sensor.sensor_name, sensor_type: @sensor.sensor_type } }
    end
  ...
  test "should update sensor" do
    patch sensor_url(@sensor), params: { sensor: { sensor_name: @sensor.sensor_name, sensor_type: @sensor.sensor_type } }
